...
LATEST_OUTPUT = OUTPUT_DIR / "energy-dashboard-card.png"
...
def main():
    ...
    timestamped_output = OUTPUT_DIR / f"energy-dashboard-card-{timestamp}.png"
    ...
    with sync_playwright() as p:
        ...
        print("Waiting for updated dashboard markers...")
        ...
        print("Taking screenshot from #capture...")
